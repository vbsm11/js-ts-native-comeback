...
// полиморфизм - способность обращаться к объектам, наследованным от одного родительского класса (и расширенных от родительского)
// как к одинаковым сущностям, но которые могут иметь дополнительные возможности за счет наследования (расширения)
// например, набор кнопок - они все кнопки, они нажимаются, щелкают, находятся на какой-то панели, но каждая выполняет свою доп. функцию
